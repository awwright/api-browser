...
routes.addTemplate('http://localhost/codemirror/addon/lint/json-lint.js', null, new RouteStatic('codemirror-5.34.0/addon/lint/json-lint.js', 'application/ecmascript'));
